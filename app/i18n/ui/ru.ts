...
export const ui: BaseUiDictionary = {
  meta: {
    title: "Anatomy Atelier — Загляни внутрь своего тела",
    description: "Изучай сердце, мозг, лёгкие и другие органы в 3D, отвечай на новый вопрос каждый день и смотри на органы в настоящем размере у себя в комнате. Анатомия для любознательных детей на 12 языках.",
    ogTitle: "Anatomy Atelier — Загляни внутрь своего тела",
    ogDescription: "Органы в 3D, вопрос дня и AR в настоящем размере — анатомия для любознательных детей.",
    imageAlt: "Анатомический препарат сердца, парящий над подставкой, рядом с логотипом Anatomy Atelier",
  },
  brand: { tagline: "Загляни внутрь своего тела", home: "Главная страница Anatomy Atelier" },
