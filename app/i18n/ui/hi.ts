...
export const ui: BaseUiDictionary = {
  meta: {
    title: "Anatomy Atelier — अपने शरीर के अंदर झाँको",
    description: "3D में हृदय, मस्तिष्क, फेफड़े और बहुत कुछ देखो, हर दिन एक नए सवाल का जवाब दो और अंगों को असली आकार में अपने कमरे में देखो। जिज्ञासु बच्चों के लिए शरीर रचना, 12 भाषाओं में।",
    ogTitle: "Anatomy Atelier — अपने शरीर के अंदर झाँको",
    ogDescription: "3D अंग, रोज़ का सवाल और असली आकार में AR — जिज्ञासु बच्चों के लिए शरीर रचना।",
    imageAlt: "एक चौकी पर तैरता शारीरिक हृदय, Anatomy Atelier के नाम-चिह्न के साथ",
  },
  brand: { tagline: "अपने शरीर के अंदर झाँको", home: "Anatomy Atelier मुखपृष्ठ" },
