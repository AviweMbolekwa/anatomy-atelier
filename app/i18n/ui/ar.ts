...
export const ui: BaseUiDictionary = {
  meta: {
    title: "Anatomy Atelier — اكتشف ما بداخل جسمك",
    description: "استكشف القلب والدماغ والرئتين وغيرها ثلاثية الأبعاد، وأجب عن سؤال جديد كل يوم، وشاهد الأعضاء بحجمها الحقيقي في غرفتك. علم التشريح للأطفال الفضوليين، بـ12 لغة.",
    ogTitle: "Anatomy Atelier — اكتشف ما بداخل جسمك",
    ogDescription: "أعضاء ثلاثية الأبعاد، وسؤال يومي، وواقع معزز بالحجم الحقيقي — علم التشريح للأطفال الفضوليين.",
    imageAlt: "عيّنة قلب تشريحية تطفو فوق قاعدة، إلى جانب شعار Anatomy Atelier",
  },
  brand: { tagline: "اكتشف ما بداخل جسمك", home: "الصفحة الرئيسية لـ Anatomy Atelier" },
  ...
  cards: {
    ...
    microscopic: "تحت المجهر", compareOrgans: "مقارنة الأعضاء", functionAnimation: "رسم متحرك للوظيفة",
    clinicalNotes: "ملاحظات سريرية", whereItWorks: "أين يعمل", commonConditions: "الأمراض الشائعة",
    exploreTissue: "انظر عن قرب", openComparison: "فتح المقارنة", playAnimation: "تشغيل الرسم المتحرك",
